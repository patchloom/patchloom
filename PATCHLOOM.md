...
- Bool peels (match `edit_error_kind`): `api::is_already_exists` (force/overwrite), `api::is_not_found`, `api::is_conflicts`, `api::is_changes_detected`; string peel: `api::error_kind_str` for CLI-stable envelopes (#1947 / #1948).
