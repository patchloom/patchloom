...
[![Tests](https://img.shields.io/badge/tests-1008%20passing-brightgreen)](#)
...
1008 passing tests across 18 core commands, plus the optional `mcp-server` command. Tested with Grok 4.3, GPT-5.4, and Claude Opus 4.6.
