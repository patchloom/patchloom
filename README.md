...
[![Tests](https://img.shields.io/badge/tests-826%20passing-brightgreen)](#)
...
826 passing tests across 15 core commands, plus the optional `mcp-server` command. Tested with Grok 4.3, GPT-5.4, and Claude Opus 4.6.
