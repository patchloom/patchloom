...
- **Tx structured output serialize errors.** If JSON serialization of a tx/batch report fails, the failure is printed to stderr instead of producing empty stdout with no diagnostic.
