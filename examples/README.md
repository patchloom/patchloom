...
| [11-ast-operations.sh](11-ast-operations.sh) | AST-aware operations: list, read, rename, validate, search, refs, deps, map, diff, impact, replace, replace-symbol, delete-symbol | `ast list`, `ast read`, `ast rename`, `ast validate`, `ast search`, `ast refs`, `ast deps`, `ast map`, `ast diff`, `ast impact`, `ast replace`, `ast replace-symbol`, `ast delete-symbol` |
