...
| [08-mcp-tool-call.json](08-mcp-tool-call.json) | Reference showing MCP tool call arguments for common operations (not a tx plan) | `patchloom_doc_set`, `patchloom_search`, `patchloom_batch`, `patchloom_tx`, `patchloom_rename`, `patchloom_md_table_append` |
