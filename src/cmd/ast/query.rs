...
mod tests {
    ...
    #[test]
    // Unique: CLI query remapper; sole-file search is Err(parse_timeout), not Ok(no_matches).
    ...
    #[test]
    // Unique: CLI dir-walk remapper (mutex + par_process) must not become no_matches.
