...
//!
//! ```toml
//! patchloom = { version = "0.28.1", default-features = false, features = ["ast"] } // x-release-please-version
//! ```
//!
...
pub use api::{
    ...
    lifecycle_cmds, load_text, load_text_strict, merge_match_modes, parse_unified_diff, peel_error,
