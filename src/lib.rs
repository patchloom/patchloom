...
//! ```toml
//! [dependencies]
//! patchloom = { version = "0.30.0", default-features = false } // x-release-please-version
//! ```
//!
//! Or with AST support:
//!
//! ```toml
//! patchloom = { version = "0.30.0", default-features = false, features = ["ast"] } // x-release-please-version
//! ```
//!
