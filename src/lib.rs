...
//! ```toml
//! [dependencies]
//! patchloom = { version = "0.35.2", default-features = false } // x-release-please-version
//! ```
//!
//! Or with AST support:
//!
//! ```toml
//! patchloom = { version = "0.35.2", default-features = false, features = ["ast"] } // x-release-please-version
//! ```
//!
