...
///
/// When the selector matches more than one value, returns
/// [`crate::exit::AmbiguousError`]. Bare object keys at an array root
/// (multi-doc YAML) return [`crate::exit::TypeErrorError`] like
/// [`query_get`] / [`query_has`].
...
/// When the selector matches more than one value, returns
/// [`crate::exit::AmbiguousError`]. Bare object keys at an array root
/// return type_error like [`query_get`].
